...
(function() {
  ...
  function getDecryptedUserData() {
    try {
      ...
      // Error: Cannot decrypt user data
      // If there's an error, remove corrupt data to avoid repeating errors
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Router: Check current page vs required step
    ...
    if (currentPage !== null && currentPage !== requiredStep) {
      // Redirect from current step to required step
